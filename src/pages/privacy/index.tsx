            ...
            <div className="page-content">
                ...
                <Container>
                    <div className={styles.content}>
                        ...
                        <p>
                            Our website includes a contact form which allows us to respond to your enquiries. The information you provide may be used to get in touch with you.
                        </p>
                        <p>
                        ...
                        <p>
                            If you have any questions about our privacy practices, please feel free to <Link href="/#contact" style={{ color: "var(--mary-blue)" }}>contact us</Link>.
                        </p>
                    </div>
                </Container>
                <Footer />
